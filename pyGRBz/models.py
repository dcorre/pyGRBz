...
def Flux_template(wvl,F0,wvl0,norm,beta,z,Av,ext_law,Host_dust,Host_gas,MW_dust,MW_gas,DLA,igm_att):
    Flux=SPL_sed(wvl,F0,wvl0,norm,beta) * sed_extinction(wvl,z,Av,ext_law=ext_law,Host_dust=Host_dust,Host_gas=Host_gas,MW_dust=MW_dust,MW_gas=MW_gas,DLA=DLA,igm_att=igm_att)
    return Flux
